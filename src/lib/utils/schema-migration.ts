...
export function getFormulationName(obj: any): string | null {
  return ("formulation_name" in obj ? obj.formulation_name : 
...
export function getFormulationCategory(obj: any): string | null {
  return ("formulation_category" in obj ? obj.formulation_category : 
          ("product_category" in obj ? obj.product_category : null)) as string | null;
}
...
export function getFormulationStatus(obj: any): string | null {
  return ("formulation_status" in obj ? obj.formulation_status : 
          ("status" in obj ? obj.status : null)) as string | null;
}
...
export function getCountryStatus(obj: any): string | null {
  return ("country_status" in obj ? obj.country_status : 
          ("registration_status" in obj ? obj.registration_status : null)) as string | null;
}
...
export function getUseGroupStatus(obj: any): string | null {
  return ("use_group_status" in obj ? obj.use_group_status : 
          ("registration_status" in obj ? obj.registration_status : null)) as string | null;
}
...
export function getFormulationReadiness(obj: any): string | null {
  return ("formulation_readiness" in obj ? obj.formulation_readiness : 
          ("readiness" in obj ? obj.readiness : null)) as string | null;
}
...
export function getCountryReadiness(obj: any): string | null {
  return ("country_readiness" in obj ? obj.country_readiness : null) as string | null;
}
...
export function getPlannedSubmissionDate(obj: any): string | null {
  return ("earliest_planned_submission_date" in obj ? obj.earliest_planned_submission_date : 
          ("earliest_submission_date" in obj ? obj.earliest_submission_date : null)) as string | null;
}
...
export function getPlannedApprovalDate(obj: any): string | null {
  return ("earliest_planned_approval_date" in obj ? obj.earliest_planned_approval_date : 
          ("earliest_approval_date" in obj ? obj.earliest_approval_date : null)) as string | null;
}
...
export function getActualSubmissionDate(obj: any): string | null {
  return ("earliest_actual_submission_date" in obj ? obj.earliest_actual_submission_date : 
          ("actual_submission_date" in obj ? obj.actual_submission_date : null)) as string | null;
}
...
export function getActualApprovalDate(obj: any): string | null {
  return ("earliest_actual_approval_date" in obj ? obj.earliest_actual_approval_date : 
          ("actual_approval_date" in obj ? obj.actual_approval_date : null)) as string | null;
}
