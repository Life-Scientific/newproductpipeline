  ...
  public: {
    Tables: {
      ...
      business_case: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_case_v2_previous_group_id_fkey"
          ...
          },
          {
            ...
            referencedColumns: ["business_case_group_id"]
          },
        ]
      }
      business_case_backup_pre_jsonb: {
        Row: {
          assumptions: string | null
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "business_case_old"
            referencedColumns: ["business_case_id"]
          },
          {
            foreignKeyName: "business_case_use_groups_business_case_id_fkey"
      ...
      formulation_country: {
        Row: {
          ...
          formulation_id: string
          include_in_financial_plan: boolean
          is_active: boolean | null
          is_eu_approved_formulation: boolean | null
          is_novel: boolean | null
          last_date_available_for_sale: string | null
      ...
      short_url_clicks: {
        ...
        Relationships: [
          {
            foreignKeyName: "short_url_clicks_short_url_id_fkey"
    ...
    Views: {
      vw_active_portfolio: {
        Row: {
          ...
          formulation_code: string | null
          formulation_country_id: string | null
          include_in_financial_plan: boolean | null
          is_eu_approved_formulation: boolean | null
          is_novel: boolean | null
          last_date_available_for_sale: string | null
    ...
    Functions: {
      ...
      can_access_url: { Args: { p_url: string }; Returns: boolean }
      ...
      preview_cogs_update: {
        Args: { p_country_code?: string; p_formulation_code: string }
        Returns: {
          business_case_group_id: string
          country_code: string
          current_cogs_year1: number
          current_cogs_year10: number
          formulation_code: string
          total_records: number
          use_group_variant: string
        }[]
      }
      rollback_cogs_update: {
        Args: {
          p_new_group_ids: string[]
          p_rollback_reason: string
          p_rolled_back_by: string
        }
        Returns: {
          restored_groups: number
          rolled_back_groups: number
        }[]
      }
      update_cogs_for_formulation: {
        Args: {
          p_change_reason: string
          p_country_code?: string
          p_effective_fiscal_year?: string
          p_formulation_code: string
          p_new_cogs_values: Json
          p_updated_by: string
        }
        Returns: {
          affected_bc_groups: number
          affected_bc_records: number
          new_bc_group_ids: string[]
        }[]
      }
    }
    Enums: {
