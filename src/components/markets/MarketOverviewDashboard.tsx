...
export function MarketOverviewDashboard({
  ...
  const [sortBy, setSortBy] = useState<"revenue" | "margin" | "formulations">(
    "revenue",
  );
  ...
  const marketMetrics = useMemo(() => {
    ...
    registrations.forEach((reg) => {
      ...
      const metric = Object.values(metrics).find(
        (m) => m.countryName === reg.country_name,
      );
      if (!metric) return;
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {globalMetrics.formulationCount}
              </div>
              <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {globalMetrics.registrationCount}
              </div>
              <p className="text-xs text-muted-foreground mt-1">
            ...
            <div className="space-y-3">
              ...
              {marketMetrics.length === 0 && (
                <div className="text-center py-8 text-muted-foreground">
                  No market data available. Create business cases to see market
                  analysis.
                </div>
              )}
            </div>
