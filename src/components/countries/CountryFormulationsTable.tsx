...
export function CountryFormulationsTable({
  formulations,
  countryName,
}: CountryFormulationsTableProps) {
  ...
  return (
    <Card>
      <CardHeader className="space-y-1.5">
        ...
        <CardDescription>
          {formulations.length} formulation
          {formulations.length !== 1 ? "s" : ""} registered or targeted for this
          country
        </CardDescription>
      </CardHeader>
      <CardContent>
