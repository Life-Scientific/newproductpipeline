...
export function SegmentRevenueMatrix({
  businessCases,
}: SegmentRevenueMatrixProps) {
  const {
  ...
  businessCases.forEach((bc) => {
    ...
    const category =
      (("formulation_category" in bc
        ? (bc as any).formulation_category
        : "product_category" in bc
          ? bc.product_category
          : null) as string | null) || "Other";
