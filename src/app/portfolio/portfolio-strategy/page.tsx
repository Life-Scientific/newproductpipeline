import { getFormulations, getBusinessCases, getActivePortfolio, getAllProtectionStatus } from "@/lib/db/queries";
...
export default async function PortfolioStrategyPage() {
  const [formulations, businessCases, activePortfolio, protectionStatus] = await Promise.all([
    getFormulations(),
    getBusinessCases(),
    getActivePortfolio(),
