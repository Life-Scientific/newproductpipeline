...
import { AlertTriangle, CheckCircle, Building2, FlaskConical } from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="space-y-1">
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-3xl font-bold tracking-tight">{ingredient.ingredient_name}</h1>
              <Badge variant={ingredient.is_active ? "default" : "secondary"} className="text-base px-3">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium">System Identity</CardTitle>
              </CardHeader>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-6 border-b">
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-bold">{totalFormulations}</span>
                  <span className="text-xs text-muted-foreground">{selectedFormulations} selected</span>
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-xs text-muted-foreground">{suppliers.filter((s: any) => s.is_primary).length} primary</span>
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div>
                  <Badge variant={(supplyRiskColors[ingredient.supply_risk || ""] as any) || "secondary"}>
              ...
              <TabsContent value="overview" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Compliance and risk assessment information</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-6 md:grid-cols-2">
                      <div className="space-y-3">
                        ...
                        <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                          ...
                          {ingredient.supply_risk_notes ? (
                            ...
                            <p className="text-sm text-muted-foreground italic mt-2">No risk notes provided.</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-muted-foreground">EU Approval</span>
                            <Badge variant={ingredient.is_eu_approved ? "default" : "outline"}>
                          ...
                          {ingredient.regulatory_notes ? (
                            ...
                            <p className="text-sm text-muted-foreground italic mt-2">No regulatory notes provided.</p>
                          )}
                        </div>
                      </div>
                    </div>
