        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              Model &ldquo;what-if&rdquo; scenarios by adjusting COGS, NSP, and
              Volume. Compare multiple scenarios against your baseline.
            </p>
          </div>

          <ScenarioPlanningClient businessCases={businessCases} />
        </div>
      </AnimatedPage>
    </div>
  );
