      ...
      <AnimatedPage>
        <div className="space-y-6">
          <div className="space-y-2">
            <h1 className="text-2xl sm:text-3xl font-bold">Blacklisted Formulation Codes</h1>
          ...
          <Alert>
            ...
            <AlertDescription>
              These formulation codes exist in external systems and are blacklisted to prevent 
              auto-generation from assigning them to new formulations. They will not appear in 
              the main formulations list.
            </AlertDescription>
          </Alert>

          <Card>
            <CardHeader>
              <CardTitle>Blacklisted Formulations ({formulations.length})</CardTitle>
              <CardDescription>
